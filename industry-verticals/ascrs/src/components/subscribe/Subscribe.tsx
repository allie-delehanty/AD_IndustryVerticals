    ...
    >
      <div className="container max-w-4xl md:max-w-5xl md:px-10">
        <div className="grid items-center gap-y-6 md:grid-cols-2 md:gap-x-12 md:gap-y-0">
          {/* Headline */}
          <h2 className="text-primary text-2xl leading-tight font-bold xl:text-3xl">
          ...
          <form className="w-full md:max-w-lg" action="">
            ...
            <div className="relative">
              <input
                ...
                className="border-border text-foreground-light placeholder:text-foreground-muted bg-background focus:border-secondary h-12 w-full rounded-md border ps-5 pe-32 focus:ring-2 focus:outline-none md:h-14"
              />

              <button
                type="submit"
                className="main-btn absolute top-1/2 right-2 h-9 -translate-y-1/2 md:right-3 md:h-10"
              >
  ...
  return (
    <section className={`component subscribe-banner group ${styles ?? ''}`} id={id || undefined}>
      ...
      <div className="max-w-sm">
        <div className="mb-6">
          <h2 className="text-primary text-lg leading-tight font-bold xl:text-xl">
            <SafeText field={props.fields?.Title} tag="span" />
          </h2>
        </div>
        ...
        <form className="w-full" action="">
          ...
          <input
            ...
            className="border-border text-foreground-light placeholder:text-foreground-muted bg-background focus:border-secondary h-12 w-full rounded-md border ps-5 pe-5 focus:ring-2 focus:outline-none md:h-14"
          />

          <button type="submit" className="main-btn mt-3 w-full md:h-12">
            {t('button_text') || 'Subscribe'}
          </button>
